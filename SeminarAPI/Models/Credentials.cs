...
namespace SeminarAPI.Models
{
    public class Credentials
    {
        ...
        public NAVWS.SeminarPortalIntergration_PortClient ObjNav()
        {
            ...
            var endpointAddress = new EndpointAddress("http://desktop-eq55q8h:7047/BC240/WS/CRONUS%20International%20Ltd./Codeunit/SeminarPortalIntergration");

            // Instantiate the service client with the binding and endpoint
            return new NAVWS.SeminarPortalIntergration_PortClient(binding, endpointAddress);
        }
    }
}
